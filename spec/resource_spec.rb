...
module Mint
  describe Resource do
    context "when created with a relative path and no root" do
      ...
      its(:root_directory_path) { should == Pathname.new('/tmp/mint-test') }
      ...
      its(:destination_file_path) { should == Pathname.new('/tmp/mint-test/content.html') }
      its(:destination_file) { should == '/tmp/mint-test/content.html' }
      its(:destination_directory_path) { should == Pathname.new('/tmp/mint-test') }
    ...
    context "when created with a relative path and absolute root" do
      ...
      its(:root_directory_path) { should == Pathname.new('/tmp/mint-test/alternative-root') }
      its(:source) { should == 'content.md' }
      ...
      its(:destination) { should be_nil }
      its(:destination_file_path) { should == Pathname.new('/tmp/mint-test/alternative-root/content.html') }
      its(:destination_file) { should == '/tmp/mint-test/alternative-root/content.html' }
      its(:destination_directory_path) { should == Pathname.new('/tmp/mint-test/alternative-root') }
